---
title: BIS product certification (ISI mark licence)
source_url: https://www.bis.gov.in/product-certification/products-under-compulsory-certification/
doc_type: bis_guide
retrieved: 2026-09-26
source_last_updated: September 24, 2026
---

# BIS product certification (ISI mark licence)

## Products under compulsory certification
<!-- source: https://www.bis.gov.in/product-certification/products-under-compulsory-certification/ -->
...
<!-- source: https://www.bis.gov.in/product-certification/product-certification-faq/ -->
Q 1 What is a licence?
...
Q.2 I am a manufacturer of a product and interested in applying for BIS product certification licence. How should I apply for it when I am not aware of corresponding Indian Standard Number?
...
Q.3 For which products, the BIS licence is compulsory? Or I am manufacturing a product. Is it compulsory to get BIS licence for my product?
...
Q.4 What are the essential requirements to be possessed by a manufacturer for applying to BIS for obtaining licence?
...
Q.5 How BIS grants the licence?
...
Q.6 What is the procedure for obtaining BIS licence for use of BIS Standard Mark?
...
Q.7 Where do I submit my application?or How can I apply for getting BIS licence for use of BIS standard mark (ISI) on the product?
...
Q.8 Are there any technical guidelines available for the products under Product Certification Scheme of BIS?
...
Q.9 If product specific guidelines i.e. Product Manual, SIT, grouping guidelines and/or marking fee rate for my product is not defined, will I still be able to obtain a BIS licence?
...
Q.10 Can I submit one application for different products and Indian Standards(ISS) being manufactured at the same factory location?
No, separate application for each product and ISS is required to be submitted even for same factory location.
Q.11 Can I submit one application for same product being manufactured at different factory locations?
No, separate application for each factory location is required to be submitted, even if the product and ISS is same.
Q 12: Which are the laboratories of which test report will be acceptable to BIS for the purpose of grant of licence? Or Where can I get my products tested in order to get a licence under optionv- 2?
...
Q 13. Up to how much time, the test reports will remain valid for the purpose of grant of licence under option – 2?
...
Q 14. What is the fee applicable for Certification licence for a product?
...
Q 15. What is the timeline for grant of BIS product certification licence?
...
Q 16. What are the conditions of BIS licence to use or apply a Standard Mark?
...
Q17. What are the punitive provisions for non-compliance with the conditions of the licence?
...
Q 18. What is the validity of BIS product certification licence?
...
Q 19. How should one apply for the renewal of a licence?
...
Q 20. What is deferment of licence? When does it happen?
...
Q 21. Does BIS carry any surveillance on my licence regularly?
...
Q 22. What are the duties and responsibilities of the owner of a manufacturing unit holding BIS licence regarding factory surveillance?
...
Q 23. What are the consequences of non-cooperation by the manufacturing unit during factory surveillance
...
Q 24. I have already got licence from BIS for the product as per ISS in my factory. Can I use this licence on all varieties of the product being manufactured in the factory?
...
Q. 25 What is the procedure for intimation regarding change of address or shifting of the manufacturing unit?
...
Q. 26 When can a license be suspended?
...
Q.27 When can a license be cancelled?
The licence can be cancelled under provisions of Regulation 11 of BIS (Conformity Assessment) Regulations, 2018.
Q. 28 How can a BIS licensee participate in the standard formulation/revision process?
...
## BIS Standard Mark and licence number
<!-- source: https://www.bis.gov.in/fmcs/certification-process/bis-standard-mark/ -->
IS ——–
Note: Licence number is also required to be indicated suitably on the product along with the BIS Standard Mark preferably below the Standard Mark as ‘CM/L-XXXXXXXXXX’

## Know Your Standard portal
<!-- source: https://www.bis.gov.in/know-your-standard/ -->
The ‘Know Your Standard’ feature provides a one-stop access to all the documents and data related to a selected Standard. The Standard can be searched by entering the Indian Standard (IS) Number or a Keyword (like Product name) in the search box. User can not only access the basic documents related to the standard like the PDF of IS itself, amendments, gazette notifications, scheme of testing and inspections but also details like the list of licenses, list of laboratories testing for concerned IS, classification details and composition of the committee can also be seen through the app.
Explore
User Manual
