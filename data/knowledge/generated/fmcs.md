...
source_last_updated: February 18, 2026
---
...
## FMCS FAQ
<!-- source: https://www.bis.gov.in/fmcs/fmcs-faqs/ -->
1 What is FMCS ?
...
2. Whether BIS Licence is Mandatory to import products to India?
...
3. For which products, the BIS licence is mandatory?
...
4. How to Apply for BIS Licence ?
...
5. Whether nomination of AIR is mandatory?
...
11. Whether the sample of the product drawn during inspection can be tested in any ILAC/APLAC approved lab or, any Govt lab in the country of the manufacturer ?
...
12. What is the timeline for grant of licence?
...
13. Can I submit one application for different products/ISS being manufactured at the same factory location?
No, separate application for each product/ISS is to be submitted for each factory location.
14. Can I submit one application for one product being manufactured at different locations?
No, separate application for each product/ISS is to be submitted for each factory location.
15. Whether separate application are to be made for different brand of a product manufactured at same location ?
No, the application for licence is for a product at a manufacturing premise. The firm to give submit an undertaking for the brand name with relevant documents
16. Whether any technical manual is available to help applicant to know details of required infrastructure, Scheme of Inspection and Testing, sampling guideline etc. for BIS Licence ?
...
17. I am an importer, can I apply for Licence on behalf of Manufacturer
No, Under FMCS scheme the application shall be made by the foreign manufacturer only
18. What are the process flow followed in grant of Licence
...
19. What is the validity of BIS Licence ?
...
20. For further queries please contact
